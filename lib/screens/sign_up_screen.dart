                            ...
                            return DropdownButtonFormField<String>(
                              ...
                              selectedItemBuilder: (context) {
                                return usable.map<Widget>((Currency c) {
                                  final String symbol = (c.symbol ?? '').trim();
                        ...
                        child: Padding(
                          ...
                          child: Obx(() {
                            ...
                            return DropdownButtonFormField<String>(
                              ...
                              value: (signUpController.countryId.value.isEmpty)
                                  ? null
                          ...
                          child: Obx(() {
                            ...
                            return DropdownButtonFormField<String>(
                              ...
                              alignment: box.read("language").toString() != "Fa"
                                  ? Alignment.centerLeft
                                  : Alignment.centerRight,
                              value: (signUpController.provinceId.value.isEmpty)
                                  ? null
                          ...
                          child: Obx(() {
                            ...
                            return DropdownButtonFormField<String>(
                              ...
                              alignment: box.read("language").toString() != "Fa"
                                  ? Alignment.centerLeft
                                  : Alignment.centerRight,
                              value: (signUpController.districtID.value.isEmpty)
                                  ? null
