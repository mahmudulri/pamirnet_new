...
AccountofOfficeModel accountofOfficeModelFromJson(String str) =>
    AccountofOfficeModel.fromJson(json.decode(str));

String accountofOfficeModelToJson(AccountofOfficeModel data) =>
    json.encode(data.toJson());

class AccountofOfficeModel {
  final bool? success;
  final int? code;
  ...
  factory AccountofOfficeModel.fromJson(Map<String, dynamic> json) =>
      AccountofOfficeModel(
...
class LatestTransaction {
  ...
  factory LatestTransaction.fromJson(
    ...
    counterpartyAccount: json["counterparty_account"] == null
        ? null
        : Account.fromJson(json["counterparty_account"]),
    currency: json["currency"] == null
        ? null
        : Currency.fromJson(json["currency"]),
  );
