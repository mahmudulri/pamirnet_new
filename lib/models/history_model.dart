...
class HistoryModel {
  ...
  HistoryModel({this.success, this.message, this.data, this.payload});
...
class Order {
  ...
  factory Order.fromJson(Map<String, dynamic> json) {
    return Order(
      ...
      rechargebleAccount: json['rechargeble_account']?.toString(),
      bundle: json['bundle'] == null
          ? null
          : Bundle.fromJson(Map<String, dynamic>.from(json['bundle'])),
